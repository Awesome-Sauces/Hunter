...
//This is your trait that will be applied to a npc using the /trait hunterTraitname command. Each NPC gets its own instance of this class.
//the Trait class has a reference to the attached NPC class through the protected field 'npc' or getNPC().
//The Trait class also implements Listener so you can add EventHandlers directly to your trait.
public class hunterTrait extends Trait {
	public hunterTrait() {
		super("hunterTrait");
		plugin = JavaPlugin.getPlugin(hunter.class);
	}
	...
	public void onAttach() {
		plugin.getServer().getLogger().info(ChatColor.GREEN + npc.getName() + " has been assigned hunterTrait!");
	}
